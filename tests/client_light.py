...
# позади полосу открытого коридора длиной в десяток клеток за пределом
# обзора, и она целиком влезает в кадр (экран 40x22.5 клетки).
WALK_LEG = 18                  # клеток в первой ноге разведки
WALK_BACK = 8                  # на сколько клеток вернуться во второй
MIN_CELLS = 20                 # клеток пола в каждом состоянии тумана
