...
// 8 f32 = 32 байт.
export const WheelOut = Object.freeze({
    SIZE: 32,
    FLOATS: 8,
...
// 52 f32 = 208 байт.
export const CarOut = Object.freeze({
    SIZE: 208,
    FLOATS: 52,
...
// 8 f32 = 32 байт.
export const CarDesc = Object.freeze({
    SIZE: 32,
    FLOATS: 8,
    HALF_WIDTH: 0,
    HALF_HEIGHT: 1,
...
// 8 f32 = 32 байт.
export const PropOut = Object.freeze({
    SIZE: 32,
    FLOATS: 8,
    PX: 0,
    PY: 1,
...
// 24 f32 = 96 байт.
export const CarSave = Object.freeze({
    SIZE: 96,
    FLOATS: 24,
    PX: 0,
    PY: 1,
...
// 32 f32 = 128 байт.
export const CarTuning = Object.freeze({
    SIZE: 128,
    FLOATS: 32,
    // --- кузов ---
