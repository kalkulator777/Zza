...
// Байт высоты -> метры. Цена деления 2 см, потолок 5,10 м (§12.30): при 1 см
// потолка 2,55 м не хватало ни Rapier (пик 3,72 м), ни классике (2,84 м), и
// соседи видели, как чужая машина на вершине прыжка прилипает к потолку.
// Пара к HEIGHT_PER_METER в game/protocol.py: числа взаимно обратны.
const HEIGHT_SCALE = 1 / 50;          // байт по 2 см -> метры высоты
